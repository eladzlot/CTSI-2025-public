...
Recent findings further support this notion, indicating that at least part of the motivation underlying NJRE in OCD arises from interference with cognitive processes rather than the enjoyment of daily life [@melliAssessingBeliefsConsequences2020].
In other words, beyond the challenge of tolerating distress, there remains the critical task of disconfirming underlying threats that sustain anxiety [@craskeOptimizingExposureTherapy2022].
