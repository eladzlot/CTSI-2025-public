...
They play a crucial role in treating anxiety disorders [@huppertCoreFearsValues2012; @zlotnickAnatomyFearCloser2024].
...
Focusing on core threats highlights the threatening aspect of feared stimuli and thus promotes generalization of safety learning across contexts [@@zlotnickAnatomyFearCloser2024; @gillihanCommonPitfallsExposure2012].
...
Core threats are comprised from an *expectation* that an event could happen, and of the *evaluation* that this event is catastrophic [@zlotnickAnatomyFearCloser2024].
...
These threats are manifestations of the values motivating these responses [@zlotnickAnatomyFearCloser2024].
